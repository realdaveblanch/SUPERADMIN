	        ...
	        <div class="blanco top-content">
				...
				<div class="contText">
					<div class="form-box">
						...
						<h1 style="text-align: center;margin-top: 3px;">CREAR CUESTIONARIOS</h1>
						...
						<div class="copiaaadmin" id="copia">
								...
								<a href="opciones.php" class="btn btn-grey btnInit">Opciones de los clones</a>
							</div>
							<div class="vercopia" id="vercopia">
								<a href="../../../backupWEBAPP" class="btn btn-grey btnInit" name="vercopia">Ver copias de seguridad</a>
							</div>
						<button class="salir3" onclick ="location.href='logout.php'">Cerrar Sesión</button>
