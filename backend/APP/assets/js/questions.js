var questionLlood = function () {
	...
	//$idUser,$area,$categoria,$atecion2,$atecion, $comunidad
	...
	this.cargarSelect = function(tipo){
        $.ajax({
            url: 'assets/js/'+ tipo +'.json',
            async: false,
            success: function (resultadoAjax) {
...
$("body").on('click', '.init .btn', function(){
    ...
    $questionLlood.cargarSelect("pregunta1");
	$questionLlood.cargarSelect("pregunta2");
	$questionLlood.cargarSelect("pregunta3");
    $questionLlood.cargarSelect("pregunta4");
	$questionLlood.cargarSelect("pregunta5");    
	$questionLlood.cargarSelect("pregunta6");
	$questionLlood.cargarSelect("pregunta7");
	...
	//$questionLlood.cargarSelect("NombreDelJson");
...
$("body").on('click', '.continueSelect', function(){
    ...
    if ( contSelect < select.length ) {
		...
		$valores = [
		$idUser,
		//ESTOS VALORES DEBEN LLEVAR , AL FINAL SIEMPRE
        $('#pregunta1').val(),
		$('#pregunta2').val(),
		$('#pregunta3').val(),
        $('#pregunta4').val(),
		...
		// $("#provincias option:checked").attr('data-value'),
       ];
    }
});
/*---------------------------------------------------------------*/
...
$("body").on('click', '.finish .btn', function(){
    ...
    if(n == 0 ){
        ...
        //var userdata = --$valores-- [$idUser,$area,$categoria,$atecion2,$atecion, $comunidad];
        ...
        $.ajax({
            ...
            success: function (resultado) {
                var msgSucces ='<div class="desp">'+
                    '<br> '+
                    '<META http-equiv="REFRESH" CONTENT="0;URL=coment.php">'+
					'</div>';
